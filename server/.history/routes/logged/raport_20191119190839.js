...
var ventesStatistics = (ventes) =>{
    ...
    ventes.forEach((vente) => {
        ...
        postes.forEach((poste, id) => {
                if (poste.poste._id === vente.poste._id) {
                    postedChecked = id;
                }
        });
       ...
       if (!posteChecked) {
           ...
           postes[postedChecked].total = postes[postedChecked].total + Number(vente.tarif.cost);
       }
       ...
       if (!consoleChecked) {
        consoles.push({
            ...
            consoles[consoleChecked].total = consoles[postedChecked].total + Number(vente.tarif.cost);
        }
